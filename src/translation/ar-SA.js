const translation = {
    ...
    label: {
        darkThemeInvert: {
          title: 'تفعيل الوضع الداكن مع بعض المشاكل (باستخدام العكس)'
        },
        ...
        donate: 'تبرع',
        allowMultiple: {
            checkbox: 'السماح بنسخ متعددة (مع بعض المشاكل)',
            message: {
                yes: 'الآن يمكنك استخدام نسخ متعددة مع بعض المشاكل.',
                no: 'الآن، يُسمح بنسخة واحدة فقط، بدون مشاكل'
            }
        },
        disableHide: {
        ...
        clearCache: 'قم بتسجيل الخروج أولاً، ثم انقر على خيار القائمة هذا لمسح ذاكرة التخزين المؤقت',
        quit: 'إنهاء',
        show: 'إظهار',
        hide: 'إخفاء',
