...
# 📚 P3X Onenote Linux v2019.2.17-9  
...
## Electron problem
Since Electron v3 the tray left click is executing the as right click, for some reason (Electron bug 🐛).  
...
[**P3X-ONENOTE**](https://pages.corifeus.com/onenote) Build v2019.2.17-9 
